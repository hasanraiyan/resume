    ...
    try {
        ...
        const achievements = [
            ...
            },
            {
                ...
                description: 'Featured for building PYQDeck, an AI platform that streamlines exam prep for students.',
                type: 'achievement',
                displayOrder: 5
            }
        ];
        ...
        const certifications = [
            {
                ...
                description: 'Completed the LangChain Academy course on building LLM applications using TypeScript and LangChain.js.',
                type: 'certification',
                displayOrder: 1
            },
            {
                ...
                description: '4-week internship on ML with Python, covering data pipelines, models, and scikit-learn.',
                type: 'certification',
                displayOrder: 2
            },
            {
                ...
                description: 'Completed foundational training on LangGraph, focusing on graph-based LLM workflows and agentic development.',
                type: 'certification',
                displayOrder: 3
            }
        ];
        ...
        await Testimonial.create({
            ...
            rating: 5,
            content: 'Raiyan demonstrated exceptional ownership by independently building our platform from the ground up and delivering a functional, stable product. He managed every stage of development backend, frontend, database architecture, and deployment while resolving major performance bottlenecks with practical and scalable solutions. The platform is now live and expanding on the solid technical foundation he created. Raiyan consistently proved to be reliable, proactive, and continues to provide valuable support and improvements post-launch.',
        ...
        await ToolTeaserSection.create({
            ...
            imageAiDescription: 'Experience the same AI technology I use for my projects. Describe anything, and watch it manifest in seconds.',
            ...
            presentationDescription: 'Just describe your topic. The AI agent researches, outlines, and generates complete visual presentation slides in seconds.',
        ...
        if (siteConfig) {
            ...
            siteConfig.newsletterDescription = 'Subscribe to our newsletter for the latest projects, articles, and insights.';
            siteConfig.newsletterPlaceholder = 'Enter your email address';
            siteConfig.newsletterButtonText = 'Subscribe';
            siteConfig.privacyText = "Join our newsletter for updates on new projects, articles, and insights. We respect your privacy and won't spam you.";
