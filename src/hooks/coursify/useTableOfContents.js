    ...
    for (const line of lines) {
      ...
      if (headingMatch) {
        ...
        const blockMatch = text.match(
          /^\[(MdBlock|QuizBlock|VideoBlock|ResourceBlock|StepByStepBlock|AccordionBlock|TabsBlock|CalloutBlock|TimelineBlock)\]/
        );
        ...
        if (blockMatch) {
          ...
          else if (type === 'AccordionBlock') text = 'Details & FAQ';
          ...
          else if (type === 'TimelineBlock') text = 'Timeline';
