  ...
  projects: [
    {
      ...
      details: {
        ...
        challenge:
          'Create a high-performance e-commerce platform that maintains luxury brand aesthetics while providing smooth user experience across all devices.',

        solution:
          'Implemented advanced lazy loading, optimized images with next-gen formats, and created custom animations that enhance rather than hinder performance.',
...

    {
      ...
      details: {
        ...
        challenge:
          'Balance heavy animations and 3D elements with performance requirements while maintaining cross-browser compatibility.',

        solution:
          'Progressive enhancement approach with fallbacks, code-splitting, and optimized asset delivery.',
...

    {
      ...
      details: {
        ...
        challenge:
          'Handle real-time data updates for thousands of concurrent users while maintaining responsive UI and accurate visualizations.',

        solution:
          'Implemented WebSocket connections, data aggregation layers, and optimized rendering with virtual scrolling.',
    ...
    // Additional non-featured projects
    {
      ...
      description:
        'Mobile-first restaurant reservation platform with real-time availability, menu browsing, and integrated payment system.',
      fullDescription: `
      ...
      details: {
        ...
        challenge:
          'Create intuitive booking flow that works offline and syncs when connection is restored.',

        solution:
          'Implemented offline-first architecture with conflict resolution and optimistic updates.',
...

    {
      ...
      description:
        'Full-featured real estate marketplace with advanced search, virtual tours, and mortgage calculator integration.',
      ...
      details: {
        ...
        challenge:
          'Manage large dataset of properties with complex filtering and real-time updates.',
...

    {
      ...
      description:
        'Comprehensive fitness app with workout tracking, nutrition planning, and social features for motivation.',
      ...
      details: {
        ...
        challenge:
          'Seamless integration with multiple fitness devices and platforms while maintaining user privacy.',

        solution:
          'Built unified API layer with strong encryption and user-controlled data sharing.',

        results: ['75K+ downloads', '4.7★ rating', '85% user retention', 'Featured by Apple'],
      },
...

    {
      ...
      description:
        'End-to-end event management solution with ticketing, attendee management, and analytics.',
      ...
      details: {
        ...
        challenge:
          'Handle high traffic during ticket sales with zero downtime and accurate inventory management.',

        solution:
          'Implemented queue system, database optimization, and auto-scaling infrastructure.',
...

    {
      ...
      description:
        'Interactive e-learning platform with video courses, quizzes, progress tracking, and certification.',
      ...
      thumbnail:
        'https://images.unsplash.com/photo-1501504905252-473c47e087f8?w=800&h=600&fit=crop&crop=center',
      images: [
        {
          id: 1,
      ...
      details: {
        ...
        challenge:
          'Deliver smooth video streaming and interactive content to users with varying internet speeds.',
...
export const getProjectsByTech = (tech) => {
  return projectsData.projects.filter((project) =>
    project.tags.some((tag) => tag.name.toLowerCase() === tech.toLowerCase())
  );
};
