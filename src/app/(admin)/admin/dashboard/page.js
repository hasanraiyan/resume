          ...
          <Link href="/admin/sections" className="group">
            <Card className="p-6 hover:shadow-xl transition-all duration-300 border-2 border-transparent hover:border-black group-hover:bg-neutral-900 group-hover:text-white">
              <div className="flex items-start space-x-4">
                ...
                <div className="flex-1">
                  <h3 className="font-semibold text-black group-hover:text-white mb-1">Manage Sections</h3>
                  <p className="text-sm text-neutral-600 group-hover:text-neutral-300">Customize website sections</p>
                </div>
              </div>
            </Card>
          </Link>
          ...
          <Link href="/admin/analytics" className="group">
            <Card className="p-6 hover:shadow-xl transition-all duration-300 border-2 border-transparent hover:border-black group-hover:bg-neutral-900 group-hover:text-white">
              <div className="flex items-start space-x-4">
                ...
                <div className="flex-1">
                  <h3 className="font-semibold text-black group-hover:text-white mb-1">View Analytics</h3>
                  <p className="text-sm text-neutral-600 group-hover:text-neutral-300">Check website analytics and insights</p>
                </div>
              </div>
            </Card>
          </Link>
          ...
          <Link href="/admin/chatbot" className="group">
            <Card className="p-6 hover:shadow-xl transition-all duration-300 border-2 border-transparent hover:border-black group-hover:bg-neutral-900 group-hover:text-white">
              <div className="flex items-start space-x-4">
                ...
                <div className="flex-1">
                  <h3 className="font-semibold text-black group-hover:text-white mb-1">Chatbot Settings</h3>
                  <p className="text-sm text-neutral-600 group-hover:text-neutral-300">Configure AI chatbot settings</p>
                </div>
              </div>
            </Card>
          </Link>
