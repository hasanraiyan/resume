...
export default function AchievementsSettingsPage() {
  ...
  useEffect(() => {
    fetch('/api/admin/sections/achievements')
      .then((res) => res.json())
      .then((data) => {
        if (data.success) {
  ...
  const handleSave = async (e) => {
    ...
    const res = await fetch('/api/admin/sections/achievements', {
      method: 'POST',
  ...
  if (loading) {
    return (
      <AdminPageWrapper title="Achievements & Certifications">
  ...
  return (
    <AdminPageWrapper
      ...
      description="Manage your achievements and certifications sections."
    >
      {message.text && (
        <div
      ...
      <form onSubmit={handleSave} className="space-y-8">
        <FormSection
          title="Achievements"
          description="Configure the title and description for your achievements section."
        >
          <div className="space-y-6">
            <div>
            ...
            <div>
              ...
              <textarea
                ...
                onChange={handleChange}
                placeholder="e.g., Milestones that inspire"
                rows={3}
        ...
        <FormSection
          ...
          description="Configure the title and description for your certifications section."
        >
          <div className="space-y-6">
            <div>
              <label className="block text-sm font-semibold text-black mb-2 uppercase tracking-wider">
            ...
            <div>
              ...
              <textarea
                ...
                onChange={handleChange}
                placeholder="e.g., Continuous learning & professional growth"
                rows={3}
                className="w-full px-4 py-3 border-2 border-neutral-200 rounded-lg resize-none"
              />
            </div>
