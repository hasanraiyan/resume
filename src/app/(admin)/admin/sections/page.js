            ...
            <Card className="p-6 opacity-60 border-2 border-dashed border-neutral-300">
              <div className="flex items-start space-x-4">
                <div className="w-12 h-12 bg-neutral-300 rounded-lg flex items-center justify-center">
                  <i className="fas fa-briefcase text-neutral-500 text-lg"></i>
                </div>
                <div className="flex-1">
                  <h3 className="font-semibold text-neutral-500 mb-1">Services Section</h3>
                  <p className="text-sm text-neutral-400">Coming soon - highlight your offered services</p>
                </div>
              </div>
            </Card>
          </div>
