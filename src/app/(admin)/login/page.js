...
function AdminLogin() {
  ...
  const [authConfig, setAuthConfig] = useState({ totpEnabled: null, googleEnabled: null });
  ...
  useEffect(() => {
    fetch('/api/auth/config')
      ...
      .catch(() => setAuthConfig({ totpEnabled: false, googleEnabled: false }));
  }, []);
            ...
            {authConfig.googleEnabled && (
              <div className="space-y-3">
                <button
                  ...
                  className="w-full flex items-center justify-center gap-3 py-3 px-4 border-2 border-neutral-200 rounded-lg hover:border-black transition-colors duration-200 font-semibold text-black"
                >
              ...
              {stage === 'credentials' && (
                <>
                  ...
                  <Button
                    type="submit"
                    variant="primary"
                    disabled={!hasValidInitialCreds || authConfig.totpEnabled === null || isLoading}
                    className="w-full py-3 px-4 font-semibold disabled:opacity-50 disabled:cursor-not-allowed"
                  >
                    {isLoading ? 'Signing in...' : authConfig.totpEnabled ? 'Next' : 'Sign in'}
                  </Button>
                </>
              )}
