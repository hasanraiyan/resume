...
import { createSnaplinksMcpServer } from '@/lib/mcp/snaplinksServer';
...
function unauthorizedResponse(description) {
  ...
  return new Response(JSON.stringify({ error: 'unauthorized', error_description: description }), {
    ...
    headers: {
      ...
      'WWW-Authenticate': `Bearer realm="${base}/api/mcp/snaplinks", resource_metadata="${base}/.well-known/oauth-protected-resource"`,
    },
  });
}
...
async function handleMcpRequest(request) {
  ...
  const server = createSnaplinksMcpServer();
