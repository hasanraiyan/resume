...
export async function GET(request) {
  ...
  try {
    ...
    async function getAnalysisData(start, end) {
    ...
    const currentAnalysis = await getAnalysisData(startDate, endDate);
    let comparisonAnalysis = null;

    if (comparisonStartDate && comparisonEndDate) {
      comparisonAnalysis = await getAnalysisData(comparisonStartDate, comparisonEndDate);
    }
