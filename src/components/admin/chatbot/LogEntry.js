...
import { ChevronDown, ChevronUp, MessageSquare, Bot, Clock, Hash, Code, Terminal, BrainCircuit } from 'lucide-react';
            ...
            <div className="flex justify-between items-start">
                <div>
                    <div className="flex items-center text-sm text-neutral-500 mb-3">
                        ...
                        <span>{timeAgo} on <code className="text-xs bg-neutral-100 px-1 py-0.5 rounded">{log.path}</code></span>
                    </div>
